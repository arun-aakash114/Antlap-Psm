...
function Managemeeting() {
  ...
  const cancelfun = (requestId) => {
    setOpen1(true);
    setrid(requestId)
    console.log(requestId, "requst id")
  }
  ...
  return (
    ...
    <Layout>
      ...
      <div className='box-header dt-mgmt'>
                        <h2 className="page-heding">Manage Meetings </h2>

                    </div>
        <Grid container spacing={3} >
          {nodata == false ? <Grid item md={9} sm={12}>
            <Card sx={{ mt: 0 }}>
              <CardContent>
          ...
          <Grid item md={3} sm={12}>
            <Card sx={{ mt: 0 }}>
              <CardContent>
              <Typography className='card-heading'>Create Meeting </Typography>
                <Box className="fo-bg-wrap">
                  <img className='custom-img' src={meet}></img>
