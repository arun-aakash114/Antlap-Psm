        ...
        axios({
          ...
          .then(function (response) {
            if (response.data.message === 'You Are LoggedIn Successfully') {
              ...
              if (response.data.data.user[1].UserTypeDescription === 'PSM') {
                navigate('/dashboard')
                // localStorage.removeItem("Username");
              } else if (response.data.data.user[1].UserTypeDescription === 'Expert' || response.data.data.user[1].UserTypeDescription === 'Expert Admin') {
