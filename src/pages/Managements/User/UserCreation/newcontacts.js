...
const [selectedCountry, setSelectedCountry] = React.useState();
  ...
  const availableState = stateList.filter((c) => c.CountryName === "India");
  console.log("availableState", availableState)
  const availableCities = cityList.filter(
    (s) => s.StateName === "Tamil Nadu"
  );
  ...
  console.log("defCountry", inputValue)
                          ...
                          <Item>
                            ...
                            <FormControl>
                              ...
                              >
                                ...
                                {stateList.map((state) => (
                                  <MenuItem value={10}>{state.StateName}</MenuItem>
                                  ))}
                              </Select> */}
                            </FormControl>
                            <Autocomplete
